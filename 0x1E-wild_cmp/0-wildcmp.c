...
/**
 * exactmode - Goes to end of a found substring.
 *
 ...
 *
 * Return: 1 if done by second string only has wildcards left, 0 if not.
 */
int wildmode(char *s1, char *s2)
{
	if (*s2 == '*')
...
/**
 * wildcmp - Compares two strings, the second with * wildcards.
